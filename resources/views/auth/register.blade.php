    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
        ...
        <div class="text-center mb-8">
            ...
            <div class="flex justify-center items-center gap-2 mb-2">
                ...
                <span class="text-xl font-extrabold text-blue-900 tracking-tight">
                    MotoRent ID
                </span>
        ...
        @if(session('success'))
            ...
            <div
                class="mb-4 p-4 bg-green-50 border-l-4 border-green-500 text-green-700 text-sm rounded-lg flex items-center">
        ...
        @if($errors->any() || session('error'))
            ...
            <div
                class="mb-4 p-4 bg-red-50 border-l-4 border-red-500 text-red-700 text-sm rounded-lg">
        ...
        <!-- LOGIN LINK -->
        <div
            class="mt-8 text-center text-sm text-gray-600 border-t border-gray-50 pt-6">
